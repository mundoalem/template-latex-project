...
\input{content/sections/usinglists}
\input{content/sections/usingmath}
\input{content/sections/usingtables}
\input{content/sections/usingfigures}
\input{content/sections/usingcitations}
